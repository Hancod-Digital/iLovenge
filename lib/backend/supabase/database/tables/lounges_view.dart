...
class LoungesViewTable extends SupabaseTable<LoungesViewRow> {
  @override
  String get tableName => 'lounges_view';

  @override
  LoungesViewRow createRow(Map<String, dynamic> data) => LoungesViewRow(data);
}

class LoungesViewRow extends SupabaseDataRow {
  LoungesViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => LoungesViewTable();
