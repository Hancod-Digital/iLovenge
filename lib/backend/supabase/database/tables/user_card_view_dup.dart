...
class UserCardViewDupTable extends SupabaseTable<UserCardViewDupRow> {
  @override
  String get tableName => 'user_card_view_dup';

  @override
  UserCardViewDupRow createRow(Map<String, dynamic> data) =>
      UserCardViewDupRow(data);
}

class UserCardViewDupRow extends SupabaseDataRow {
  UserCardViewDupRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => UserCardViewDupTable();
