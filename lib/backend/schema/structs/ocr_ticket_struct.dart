...
class OcrTicketStruct extends BaseStruct {
  OcrTicketStruct({
    String? pnr,
  ...
  static OcrTicketStruct fromMap(Map<String, dynamic> data) => OcrTicketStruct(
  ...
  static OcrTicketStruct? maybeFromMap(dynamic data) => data is Map
      ? OcrTicketStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static OcrTicketStruct fromSerializableMap(Map<String, dynamic> data) =>
      OcrTicketStruct(
  ...
  @override
  String toString() => 'OcrTicketStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is OcrTicketStruct &&
        pnr == other.pnr &&
...
OcrTicketStruct createOcrTicketStruct({
  String? pnr,
  String? departureDateTime,
  String? airline,
  String? flightNumber,
