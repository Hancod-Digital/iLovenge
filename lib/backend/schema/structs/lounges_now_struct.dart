...
class LoungesNowStruct extends BaseStruct {
  LoungesNowStruct({
  ...
  static LoungesNowStruct fromMap(Map<String, dynamic> data) =>
      LoungesNowStruct(
        cards: getStructList(
          data['cards'],
          CardsStruct.fromMap,
  ...
  static LoungesNowStruct? maybeFromMap(dynamic data) => data is Map
      ? LoungesNowStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static LoungesNowStruct fromSerializableMap(Map<String, dynamic> data) =>
      LoungesNowStruct(
  ...
  @override
  String toString() => 'LoungesNowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is LoungesNowStruct &&
...
LoungesNowStruct createLoungesNowStruct({
  String? timings,
  String? location,
  int? loungeId,
  String? mobileNo,
