...
class CardsInLoungViewStruct extends BaseStruct {
  CardsInLoungViewStruct({
    int? cardId,
    String? cardBank,
    String? cardName,
    String? cardType,
  ...
  static CardsInLoungViewStruct fromMap(Map<String, dynamic> data) =>
      CardsInLoungViewStruct(
  ...
  static CardsInLoungViewStruct? maybeFromMap(dynamic data) => data is Map
      ? CardsInLoungViewStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static CardsInLoungViewStruct fromSerializableMap(
  ...
  @override
  String toString() => 'CardsInLoungViewStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is CardsInLoungViewStruct &&
        cardId == other.cardId &&
...
CardsInLoungViewStruct createCardsInLoungViewStruct({
  int? cardId,
  String? cardBank,
  String? cardName,
  String? cardType,
